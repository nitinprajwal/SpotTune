...
## Description 🎼
SpotTune is an implementation of Shazam's song recognition algorithm based on insights from these [resources](#resources--card_file_box). It integrates Spotify and YouTube APIs to find and download songs.
...
```
git clone https://github.com/nitinprajwal/SpotTune.git
cd SpotTune
```
#### 🐳 Set Up with Docker
...
## Author :black_nib:
- Nitin Prajwal
  - Connect with me on [LinkedIn](https://www.linkedin.com/in/nitinprajwal/).
  - Check out my other [GitHub](https://github.com/nitinprajwal) projects.
  - Follow me on [Twitter](https://twitter.com/nitinprajwal).
